...
<html>
  <head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>/asset/admin_mu/plugins/iCheck/square/blue.css">
  ...
  <body class="hold-transition login-page">
    ...
    <!-- iCheck -->
    <script src="<?php echo base_url(); ?>/asset/admin_mu/plugins/iCheck/icheck.min.js"></script>
    <script>
      $(function () {
        $('input').iCheck({
