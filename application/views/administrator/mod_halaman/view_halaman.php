        ...
        <tbody>
          ...
          foreach ($record as $row){
            ...
            if ($row['kategori'] == 'layanan') {
              echo "<td><a target='_BLANK' href='".base_url()."layanan/d/$row[judul_seo]'>layanan/d/$row[judul_seo]</a></td>";
            }else{
              echo "<td><a target='_BLANK' href='".base_url()."halaman/detail/$row[judul_seo]'>halaman/detail/$row[judul_seo]</a></td>";}
