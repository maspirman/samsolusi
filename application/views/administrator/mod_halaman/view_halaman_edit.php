...
<td><select class='form-control' name='k'><option value='$rows[kategori]'>$rows[kategori]</option><option value='default'>default</option><option value='layanan'>layanan</option></select></td></tr>
