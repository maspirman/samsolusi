    ...
    <ul class="nav nav-pills nav-sidebar flex-column nav-flat menu-open nav-legacy nav-compact" data-widget="treeview" role="menu" data-accordion="false">
      ...
      <li class="nav-item has-treeview">
        <a href="#" class="nav-link">
          ...
          <p>Halaman <i class="right fas fa-angle-left"></i></p></a>
          <ul class="nav nav-treeview">
            <?php
            $cek=$this->model_app->umenu_akses("halamanbaru",$this->session->id_session);
            if($cek==1 OR $this->session->level=='admin'){
              echo "<li class='nav-item'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/halamanbaru'><i class='far fa-circle nav-icon text-success'></i> <p>Data Halaman</p></a></li>";
            }
            $cek=$this->model_app->umenu_akses("halamanbaru",$this->session->id_session);
            if($cek==1 OR $this->session->level=='admin'){
              echo "<li class='nav-item'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/tambah_halamanbaru'><i class='far fa-circle nav-icon text-success'></i> <p>Halaman Baru</p></a></li>";
            }
            ?>
          </ul>
        </li>
        <li class="nav-item has-treeview">
          <a href="#" class="nav-link">
            ...
            <p>Berita <i class="right fas fa-angle-left"></i></p></a>
            <ul class="nav nav-treeview">
              <?php
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              ...
              <p>Video <i class="right fas fa-angle-left"></i></p></a>
              <ul class="nav nav-treeview">
                <?php
            ...
            <li class="nav-item has-treeview">
              <a href="#" class="nav-link">
                ...
                <p>Iklan <i class="right fas fa-angle-left"></i></p></a>
                <ul class="nav nav-treeview">
                  <?php
              ...
              <li class="nav-item has-treeview">
                <a href="#" class="nav-link">
                  ...
                  <p>Pengaturan Website <i class="right fas fa-angle-left"></i></p></a>
                  <ul class="nav nav-treeview">
                    <?php
              ...
              //mod novapage testimoni
                    ...
                    if($cek==1 OR $this->session->level=='admin'){
                      echo "<li class='nav-item novapage-testimoni'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/novapage-testimoni'><i class='far fa-circle nav-icon text-success'></i> <p> Testimoni</p></a></li>";
                    } 
              //modnovapage client 
                    $cek=$this->model_app->umenu_akses("novapage-client",$this->session->id_session);
                    if($cek==1 OR $this->session->level=='admin'){
                      echo "<li class='nav-item novapage-client'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/novapage-client'><i class='far fa-circle nav-icon text-success'></i> <p> Client</p></a></li>";
                    } 
              //modnovapage team 
                    $cek=$this->model_app->umenu_akses("novapage-team",$this->session->id_session);
                    if($cek==1 OR $this->session->level=='admin'){
                      echo "<li class='nav-item novapage-team'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/novapage-team'><i class='far fa-circle nav-icon text-success'></i> <p> Team</p></a></li>";
                    }        
              //modnovapage portfolio
                    $cek=$this->model_app->umenu_akses("novapage-portfolio",$this->session->id_session);
                    if($cek==1 OR $this->session->level=='admin'){
                      echo "<li class='nav-item novapage-portfolio'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/novapage-portfolio'><i class='far fa-circle nav-icon text-success'></i> <p> Portfolio</p></a></li>";
                    }     
              //mod novapage images
                    $cek=$this->model_app->umenu_akses("novapage-images",$this->session->id_session);
                    if($cek==1 OR $this->session->level=='admin'){
                      echo "<li class='nav-item novapage-images'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/novapage-images'><i class='far fa-circle nav-icon text-success'></i> <p> Images</p></a></li>";
                    }  
              //mod novapage
                    $cek=$this->model_app->umenu_akses("novapage",$this->session->id_session);
                    if($cek==1 OR $this->session->level=='admin'){
                      echo "<li class='nav-item novapage'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/novapage'><i class='far fa-circle nav-icon text-success'></i> <p> Konfigurasi</p></a></li>";
                    }  
                ...
                <li class="nav-item has-treeview">
                  <a href="#" class="nav-link">
                    ...
                    <p>Interaksi <i class="right fas fa-angle-left"></i></p></a>
                    <ul class="nav nav-treeview">
                      <?php
