		...
		<div class="row"> 
			<?php
			  foreach ($get_portfolio->result_array() as $portfolio) {	 
				  if ($portfolio['image'] !== '' &&  file_exists( $base_path ."asset/img_novapage/portfolio/".($portfolio['image']) ) ){
						$img_src = base_url()."asset/img_novapage/portfolio/". $portfolio['image'];
				  }
				  ?>
				  <div class="col-md-4 mb-4">
					  <div class="portfolio card h-100 card-border">
