...
echo "<div class='wrapper'>
	...
	echo "</ul>
	<p>&copy; ".date('Y')." Copyright <b>Mycoding.net</b>. All Rights reserved.<br/>Develop by. <b style='color:orange'>401XD Group</b> - Redesign by. <b style='color:orange'>Nama Anda Disini</b></p>
</div>";